...
2. 
  Checkpoint 1 -> cfg = CFG(filter_sizes=[64, 128, 256, 512], HL=[2048], epochs=25, n_folds=None) [0 - 25]  
  Checkpoint 2 -> cfg = CFG(filter_sizes=[64, 128, 256, 512], HL=[2048], epochs=10, n_folds=None) [26 - 35] 
