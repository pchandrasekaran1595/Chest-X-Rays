...
class CNN_7(nn.Module):
    def __init__(this, in_channels=1, filter_sizes=None, HL=None, OL=None, AP_size=None, use_DP=True, DP=0.5):
    ...
    def getMultiStepLR(this, optimizer=None, milestones=None, gamma=0.1):
        return optim.lr_scheduler.MultiStepLR(optimizer=optimizer, milestones=milestones, gamm=gamma)
