...
if __name__ == "__main__":
    ...
    Names, LP = fp.fit_KFold(X=X, y=y, epochs=cfg.epochs, n_folds=cfg.n_folds,
    ...
    y_pred = fp.predict_kf(Model, set(Names), ts_data, ts_data_setup.__len__(), cfg.ts_batch_size,
