...
def fit_SingleModel(model=None, optimizer=None, dataloader=None, epochs=None, criterion=None, device=None):
    breaker()
    print("Training ...")
...
def fit_KFold(X=None, y=None, epochs=None, n_folds=None,
              ...
              criterion=None, device=None, path=None, verbose=None):
...
def fit_SeedAvgKFold(X=None, y=None, epochs=None, n_folds=None, n_seeds=None,
                     IL=None, HL=None, OL=None, use_DP=None, DP1=0.2, DP2=0.5,
                     lr=1e-3, wd=0, patience=5, lr_eps=1e-6, use_all=None,
                     tr_batch_size=None, va_batch_size=None,
...
def predict_sm(model=None, dataloader=None, batch_size=None, device=None):
...
def predict_kf(model=None, names=None, dataloader=None, num_obs=None, batch_size=None, device=None, path=None):
